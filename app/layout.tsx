          ...
          itemListElement: [
            {
              ...
              itemOffered: {
                "@type": "Course",
                name: "Cumbia - Principiantes",
                description: "Clase de Cumbia para principiantes. Aprende los pasos básicos de la danza más tradicional del Carnaval.",
            ...
            },
            {
              ...
              itemOffered: {
                ...
                description: "Clase intermedia de Mapalé. Ritmo afro-colombiano libre y energético.",
                provider: { "@id": `${SITE_URL}/#organization` },
              },
            },
            {
